...
node {
    sh 'docker tag tomcat-${BUILD_TAG} 192.168.50.11/booking:tomcat-${BUILD_TAG}'
    sh 'docker login -u admin -p treeptik -e c.vandome@treeptik.fr 192.168.50.11 && docker push 192.168.50.11/booking:tomcat-${BUILD_TAG}'
}
